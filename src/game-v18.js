...
try{
  ...
  // Put the precomputed carpet table inside the generated game runtime itself.
  ...
  // Replace the Level 0 carpet formula with tile sampling + broad wear.
  ...
  // Level 0 wallpaper: broader repeat, faded paper bands, occasional damp patches.
  source=source.replace(
